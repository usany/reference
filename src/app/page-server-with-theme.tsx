...
// Server component - receives theme and language as props
export default function RootPage({ theme, language }: PageProps) {
  return (
    <>
      <RainAnimation />
      <section className={styles.hero}>
        {/* Static content that doesn't need client-side hooks */}
      ...
      {/* Interactive parts that need client-side hooks */}
