...
export default function InteractivePageContent() {
  ...
  return (
    <>
      ...
      <section className={styles.heroContent}>
        {/* Using the server component for FAQ */}
      ...
      <footer>
        <div className={styles.footerBottom}>
          ...
          <button 
            ...
            onClick={() => window.history.pushState({}, '', '?privacy=true')} 
          >
            {translation.policy}
          </button>
        </div>
      ...
      <PrivacyModal translation={translation} method={method} />
    </>
  );
}
